...
getgenv().Aiming = {
    ...
    TargetPart = {"Head", "UpperTorso", "HumanoidRootPart", "LowerTorso", "RightFoot", "LeftHand", "RightHand", "LeftLowerArm", "RightLowerArm"},
...
function Aiming.UpdateFOV()
    ...
    circle.Color = Aiming.FOVColour
    circle.Filled = Aiming.FOVFilled
    circle.Transparency = Aiming.FOVTransparency
